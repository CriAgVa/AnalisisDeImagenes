...
import fourier.HerramientasColor.CanalColor;
import java.awt.Color;
import java.awt.image.BufferedImage;
import java.util.HashMap;
import java.util.Map;
import trabajarImagen.ModificarImagen;
...
public NumeroComplejo[][] obtenerDatosPorCanal(BufferedImage imagenOriginal, CanalColor color) {
    ...
    public BufferedImage obtenerImagenFrecuencias(NumeroComplejo[][] datosIO,int w, int h,boolean reAjustarCuadrante, CanalColor canal) {
        ...
        // construir el mapeo de representacion en frecuencias utilizando FFT
            ...
            for (int y = 0; y < aux.getHeight(); y++) {
                for (int x = 0; x < aux.getWidth(); x++) {
                    ...
                    color = trabajarImagen.ModificarImagen.comprobarColor(color);
